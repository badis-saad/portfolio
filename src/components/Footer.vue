<template>
  <footer class="bg-slate-900 border-t border-slate-700 text-slate-300">
    <div class="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6">

      <!-- Crédit -->
      <p class="text-sm">
        © {{ year }} Badis Saad — Architecture & Développement
      </p>

      <!-- Logos et liens -->
      <div class="flex items-center gap-8">
        <!-- GitHub -->
        <a href="https://github.com/badis-saad" target="_blank" aria-label="GitHub" class="hover:text-lime-400 transition">
        ...
        <!-- LinkedIn -->
        <a href="https://www.linkedin.com/in/badis-saad" target="_blank" aria-label="LinkedIn" class="hover:text-lime-400 transition">
          <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
            <path
        ...
        <!-- Contact -->
        <RouterLink to="/contact" aria-label="Contact" class="hover:text-lime-400 transition">
          <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
            <path
              d="M2 6c0-1.1.9-2 2-2h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6zm2 0 8 5 8-5H4zm16 12V8l-8 5-8-5v10h16z"
            />
          </svg>
        </RouterLink>
      </div>
